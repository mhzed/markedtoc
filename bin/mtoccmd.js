...
(function() {
  ...
  if (o.argv.v) {
    preview.startServer(mdFile, o.argv.css, parseInt(o.argv.p), o.argv.s ? outFile : void 0);
  } else if (o.argv.s) {
